...
<aside class="w-64 bg-white shadow-lg hidden md:block fixed left-0 top-0 h-screen overflow-y-auto border-r border-gray-200 z-50">
  ...
  <nav class="p-4 space-y-2">
    <a href="{{ route('dashboard') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('dashboard') ? 'bg-gray-100 text-black font-semibold border-l-4 border-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black hover:border-l-4 hover:border-gray-300' }}">
    ...
    <a href="{{ route('produk') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('produk') ? 'bg-gray-100 text-black font-semibold border-l-4 border-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black hover:border-l-4 hover:border-gray-300' }}">
    ...
    <a href="{{ route('laporan') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('laporan') ? 'bg-gray-100 text-black font-semibold border-l-4 border-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black hover:border-l-4 hover:border-gray-300' }}">
    ...
    <a href="{{ route('kategori') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('kategori') ? 'bg-gray-100 text-black font-semibold border-l-4 border-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black hover:border-l-4 hover:border-gray-300' }}">
    ...
    <a href="{{ route('cards') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('cards') ? 'bg-gray-100 text-black font-semibold border-l-4 border-black' : 'text-gray-600 hover:bg-gray-100 hover:text-black hover:border-l-4 hover:border-gray-300' }}">
  ...
  <div class="flex items-center gap-4">
    <div class="relative group">
      ...
      <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200 z-50">
        ...
        <a href="{{ route('profile') }}" class="flex items-center gap-2 px-4 py-3 text-gray-700 hover:bg-gray-50 text-sm transition duration-200">
