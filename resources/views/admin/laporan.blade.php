          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2">{{ Auth::user()->products()->count() }}</p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2">{{ Auth::user()->cards()->count() }}</p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2">{{ Auth::user()->categories()->count() }}</p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2">{{ Auth::user()->products()->where('status', 'active')->count() }}</p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2">{{ Auth::user()->products()->where('status', 'coming_soon')->count() }}</p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2">{{ Auth::user()->products()->where('status', 'inactive')->count() }}</p>
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              ...
              <tbody class="divide-y divide-gray-200">
                @forelse(Auth::user()->products()->latest()->take(10)->get() as $product)
                <tr class="hover:bg-gray-50 transition duration-200">
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-3">
                      ...
                      <span class="text-sm text-gray-700 font-medium">{{ $product->title }}</span>
                    </div>
                  </td>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-700">{{ $product->created_at->format('d M Y') }}</td>
                </tr>
                @empty
                <tr>
