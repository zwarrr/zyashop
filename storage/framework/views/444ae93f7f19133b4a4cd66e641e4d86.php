...
<body class="bg-gray-50 text-gray-800">
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-200">
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <p class="font-medium text-black"><?php echo e($product->title); ?></p>
                        <p class="text-xs text-gray-500">ID: <?php echo e($product->id); ?></p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td class="px-6 py-4 text-center">
                    <div class="relative inline-block text-left">
                      <button onclick="toggleDropdown(<?php echo e($product->id); ?>)" class="p-2 hover:bg-gray-100 rounded-lg transition duration-200" title="Aksi">
                      ...
                      <div id="dropdown-<?php echo e($product->id); ?>" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                        <button onclick="openProductModal('edit', <?php echo e($product->id); ?>); toggleDropdown(<?php echo e($product->id); ?>)" class="w-full flex items-center gap-2 px-4 py-3 text-gray-700 hover:bg-gray-50 text-sm transition duration-200 text-left rounded-t-lg">
                        ...
                        <button onclick="deleteProduct(<?php echo e($product->id); ?>); toggleDropdown(<?php echo e($product->id); ?>)" class="w-full flex items-center gap-2 px-4 py-3 text-red-600 hover:bg-red-50 text-sm transition duration-200 text-left rounded-b-lg">
                ...
                <tr>
                  <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                    Belum ada produk. <a href="<?php echo e(route('produk.create')); ?>" class="text-black font-semibold hover:underline">Buat produk baru</a>
                  </td>
                </tr>
                <?php endif; ?>
              </tbody>
            ...
            <div>
              ...
              <select id="productCard" name="card_id" required class="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-black">
                ...
                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($card->id); ?>"><?php echo e($card->title); ?> - <?php echo e($card->category); ?></option>
  ...
  <script>
    ...
    let allCards = <?php echo json_encode($cards); ?>;
    ...
    document.getElementById('productForm').addEventListener('submit', async (e) => {
      ...
      let url = '<?php echo e(route("produk.store")); ?>';
...
<?php /**PATH C:\GOW\zyashop\resources\views/admin/produk.blade.php ENDPATH**/ ?>