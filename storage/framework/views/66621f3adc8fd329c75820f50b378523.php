    ...
    <div class="flex-1 flex flex-col md:ml-64">
      ...
      <main class="flex-1 mt-16 md:mt-20 p-4 md:p-8 space-y-8">
        ...
        <div class="bg-black rounded-xl p-6 md:p-8 text-white shadow-lg">
          <h2 class="text-3xl font-bold mb-2">Selamat Datang, <?php echo e(Auth::user()->name); ?>! 👋</h2>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2"><?php echo e($totalProducts); ?></p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2"><?php echo e($totalCards); ?></p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2"><?php echo e($totalCategories); ?></p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2"><?php echo e($activeProducts); ?></p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2"><?php echo e($comingSoonProducts); ?></p>
          ...
          <div class="bg-white rounded-xl p-6 shadow hover:shadow-lg transition duration-300 border-l-4 border-black">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-black mt-2"><?php echo e($inactiveProducts); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow border border-gray-200">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between pb-4 border-b border-gray-200">
                ...
                <span class="font-semibold text-black"><?php echo e(Auth::user()->name); ?></span>
              </div>
              <div class="flex items-center justify-between pb-4">
                <span class="text-gray-600">Email</span>
                <span class="font-semibold text-black"><?php echo e(Auth::user()->email); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white p-6 rounded-xl shadow border border-gray-200">
            ...
            <div class="space-y-3">
              <a href="<?php echo e(route('produk')); ?>" class="flex items-center justify-center gap-2 w-full bg-black hover:bg-gray-900 text-white px-4 py-2 rounded-lg font-medium transition duration-200">
                <svg class="feather" viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                Kelola Produk
              </a>
              <a href="<?php echo e(route('cards')); ?>" class="flex items-center justify-center gap-2 w-full bg-gray-200 hover:bg-gray-300 text-black px-4 py-2 rounded-lg font-medium transition duration-200">
              ...
              <a href="<?php echo e(route('kategori')); ?>" class="flex items-center justify-center gap-2 w-full bg-gray-200 hover:bg-gray-300 text-black px-4 py-2 rounded-lg font-medium transition duration-200">
...
<?php /**PATH C:\GOW\zyashop\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>