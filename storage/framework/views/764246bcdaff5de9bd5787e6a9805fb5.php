...
<body class="bg-gray-50 text-gray-800">
  ...
  <script>
    ...
    let allCards = <?php echo json_encode($cards ?? [], 15, 512) ?>;
    ...
    function renderCardsTable() {
      ...
      tbody.innerHTML = allCards.map(card => {
        ...
        <tr class="hover:bg-gray-50 transition duration-200 card-row" data-title="${card.title}" data-status="${card.status}">
          ...
          <td class="px-6 py-4 text-sm text-gray-900">${card.description ? card.description.substring(0, 50) + '...' : '-'}</td>
...
<?php /**PATH C:\GOW\zyashop\resources\views/admin/cards.blade.php ENDPATH**/ ?>