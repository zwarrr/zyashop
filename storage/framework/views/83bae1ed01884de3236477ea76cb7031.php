...
<div id="headerContainer" class="sticky-header pb-4 pt-4">
  ...
  <div class="flex items-center justify-between mb-4 px-3 sm:px-4">
    <div class="flex items-center gap-2">
      ...
      <h1 class="text-xl sm:text-2xl font-bold"><?php echo e($pageTitle ?? 'Products'); ?></h1>
    </div>
  ...
  <div id="categoryTabs" class="flex justify-center gap-6 pb-4 border-b border-gray-200">
    <button class="category-tab-btn <?php echo e(!isset($productType) || $productType === 'shopee' ? 'active text-red-600 border-red-600' : 'text-gray-600 border-transparent'); ?> font-semibold text-sm whitespace-nowrap pb-2 border-b-2 hover:text-black transition-colors" 
            data-type="shopee" 
            onclick="window.location.href='<?php echo e(route('products.type', 'shopee')); ?>'">
      Shopee
    </button>
    <button class="category-tab-btn <?php echo e(isset($productType) && $productType === 'tiktok' ? 'active text-red-600 border-red-600' : 'text-gray-600 border-transparent'); ?> font-semibold text-sm whitespace-nowrap pb-2 border-b-2 hover:text-black transition-colors" 
            data-type="tiktok"
            onclick="window.location.href='<?php echo e(route('products.type', 'tiktok')); ?>'">
      Tiktok Shop
    </button>
  </div>
</div>
...
</script><?php /**PATH C:\GOW\zyashop\resources\views/partials/header.blade.php ENDPATH**/ ?>