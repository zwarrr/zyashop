...
// NOTE: Removed debug routes that include image data - they caused payload too large errors
// Debug routes kept images visible in responses which exceeded Vercel's 6MB limit
